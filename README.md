# Japanese Localization for Barbeque's Delight v 1.20.1-1.0.6

## 概要
MinecraftのMOD「[Barbeque's Delight](https://www.curseforge.com/minecraft/mc-mods/barbeques-delight)」のMinecraft 1.20.1 Forge向けのバージョン1.0.6を日本語でプレイできるようにするための翻訳用リソースパックです。  
これは非公式的なもので、また、翻訳の一部にAIを使用しています。

## 動作確認環境
*   **Minecraft:** 1.20.1
*   **Forge**: 4.7.10
*   **Barbeque's Delight:** 1.0.6
...
## 注意事項・免責事項
*   本リソースパックは個人による非公式の翻訳であり、Barbeque's Delightの公式開発者様とは一切関係ありません。
